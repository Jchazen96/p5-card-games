class GamesController < ApplicationController
    ...
    def find_gofish
        ...
        if game
            ...
            Card.insert_all(
                [
                    {value: 2, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/2D.png', name: '2', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 3, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/3D.png', name: '3', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 4, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/4D.png', name: '4', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 5, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/5D.png', name: '5', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 6, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/6D.png', name: '6', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 7, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/7D.png', name: '7', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 8, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/8D.png', name: '8', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 9, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/9D.png', name: '9', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 10, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/0D.png', name: '10', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 11, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/JD.png', name: 'Jack', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 12, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/QD.png', name: 'Queen', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 13, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/KD.png', name: 'King', game_id: game.id, created_at: Time.current, updated_at: Time.current},
                    ...
                    {value: 14, suit: 'Diamond', image: 'https://deckofcardsapi.com/static/img/AD.png', name: 'Ace', game_id: game.id, created_at: Time.current, updated_at: Time.current},
